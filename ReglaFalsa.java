...
public class ReglaFalsa {
    ...
    public  double reglaFalsa(double a, double b, double porcentaje, int opc) {
        double c = 0;

        do {
            c = b - (funcion(b, opc) * (a - b) / (funcion(a, opc) - funcion(b, opc)));
    ...
    public static void main(String[] args) {
        ...
        double root = var.reglaFalsa(a, b, porcentaje, opc);
        System.out.print("\nLa raíz aproximada con el método de la regla falsa es: "+ root);
        System.out.println("");
        scanner.close();
    }
}
